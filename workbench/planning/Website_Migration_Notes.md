...
- Matt Webb's Interconnected is a long-running personal blog with old-web navigation, RSS, related/follow-up links, archive paths, Fathom analytics, Cloudflare, and a custom CSS background cycle. The inspected page uses a ten-minute CSS `@keyframes` animation to move the blog background through pastel HSL colors.
...
## Change log
- 2026-06-07: Added Interconnected to the bespoke-site references and captured the CSS color-cycle behavior.
